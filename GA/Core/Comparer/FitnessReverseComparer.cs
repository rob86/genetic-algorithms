...
namespace GA.Core.Comparer
{
    ...
    /// </summary>
    public class FitnessReverseComparer : IComparer<IChromosome>
    {
        /// <summary>
        /// Porównuje chromosomy na podstawie ich oceny dopasowania.
        /// </summary>
        ...
        /// <returns>Liczbę ujemną, jeżeli ch1 jest lepiej dopasowany; liczbe dodatnią, jeżeli ch2 jest lepiej dopasowany; zero jeżeli oba chromosomy są tak samo dobrze dopasowane.</returns>
